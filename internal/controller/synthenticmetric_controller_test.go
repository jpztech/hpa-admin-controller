...
var _ = Describe("SynthenticMetric Controller", func() {
	Context("When reconciling a resource", func() {
		...
		synthenticmetric := &scalingv1alpha1.SynthenticMetric{}

		BeforeEach(func() {
			By("creating the custom resource for the Kind SynthenticMetric")
			err := k8sClient.Get(ctx, typeNamespacedName, synthenticmetric)
